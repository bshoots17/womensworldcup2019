...
#              This file contains the aesthetics, such as HTML styling,
#              ggplot elements, images, and the paragraph text. 
#
...
## ---- Red Card ----
# used for the style of the headers
...
## ---- Full-Length Image ----
# used for the style of the full length image panel
...
## ---- Half Pitch Annotation ----
# creates a half pitch to the dimensions of a StatsBombR soccer field
# used for the shot map
# credit: this was based on code created by StatsBomb, and modified to my own purposes.
geom_halfpitch <- ggplot() + 
...
## ---- Soccer Pitch Theme ----
# used to create the aesthetics of the shot map
...
## ---- Options for Shot Map ----
# used for the shiny UI dropdown
...
## ---- Leaflet Map Icons ----
# used to map the stadiums to their images
icons <- iconList(
  hainaut = makeIcon(
    "hainaut.png",
    iconWidth = 50
